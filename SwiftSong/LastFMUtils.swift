...
class LastFMUtils {
    ...
    //hit last GN
    class func fetchImageForArtist(artist : String) {
    
        var urlStr = "http://ws.audioscrobbler.com/2.0/?method=artist.getinfo&artist=\(artist)&api_key=\(LastFMAPIKey)&format=json"
        ...
        NSURLConnection.sendAsynchronousRequest(request, queue: NSOperationQueue.mainQueue(), completionHandler: {
            ...
            //resultsDelegate.didReceiveResults(json)
        })
    }
}
